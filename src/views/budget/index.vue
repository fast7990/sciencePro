<template>
    <div class="page">
      ...
      <div class="page-content">
        ...
        style="width: 100%"
      >
        <el-table-column prop="key" label="预算编号" />
        <el-table-column prop="pv" label="预算名称" />
        <el-table-column prop="key" label="预算事项总金额" />
        <el-table-column prop="key" label="预算类型" />
        <el-table-column prop="key" label="合同状态" />
        <el-table-column prop="key" label="项目所处状态" />
