 ...
 * @LastEditors: sueRimn
 * @LastEditTime: 2021-04-17 00:08:29
 */
...
router.beforeEach(async(to, from, next) => {
    ...
    if (checkLoginResult.succ) {
        store.dispatch("user/setUserInfo", checkLoginResult)
        setToken(checkLoginResult.roleID)
    } else {
        removeToken()
    }
